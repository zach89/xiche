...
include '../Utils/Bag.php';
include '../Utils/SignGenerator.php';
//include '../Utils/SignGenerator.php';
...
class Notify
{
    ...
    public function __construct($appId, $appSecret, $mchId, $mchKey) {
        ...
        $appSecret='e04093fe9ca993b3a97b516cd6a6e965';
        $mchId='1295279801';
        $mchKey='7W66YV0NH7D5YE6K19CFWI2QQHUPR1RB';
        $this->appId = $appId;
    ...
    public function verify() {
        ...
        $signGenerator->onSortAfter(function(SignGenerator $that) {
            ...
            $that->key = '7W66YV0NH7D5YE6K19CFWI2QQHUPR1RB';
        });
